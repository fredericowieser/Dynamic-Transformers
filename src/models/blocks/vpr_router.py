...
class VPRRouter(nn.Module):
    ...
    def current_cu_detection_multiplier(self):
        return self.cu_detection_multiplier_val
    ...
    def forward(
        ...
        if self.token_wise_gating:
            ...
            CU_val = d_st_tok - (self.cu_detection_multiplier_val * ma_d_st_tok)
        else:
            ...
            CU_val = mean_d_st - (self.cu_detection_multiplier_val * mean_d_st.detach())
