#!/bin/bash
# run_scaling_experiments.sh - 4-GPU Scaling Experiments (0.5B to 7B)

set -e # Exit immediately if a command exits with a non-zero status

echo "================================================================"
echo " Starting Scaling Experiments (4-GPU Job)"
echo "================================================================"
...
for SIZE in "${SIZES[@]}"; do
    for MODEL in "${MODELS[@]}"; do
        ...
        # 1. Train Model (4 GPUs)
        echo "--> [1/3] Training $MODEL-$SIZE..."
        # We use accelerate launch for Distributed Training
        ...
        # The experiment name in default.yaml starts with experiment-
        ...
        # Non-Causal Router Evaluation (Parallelized across 4 GPUs for speed)
        python bench.py --model_path $MODEL_PATH --tasks general --batch_size 16 --output_dir "$LATEST_DIR"
        
        # Causal Router Evaluation (Parallelized across 4 GPUs for speed)
